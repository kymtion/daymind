...
let missionData: [Mission] = [
    Mission(
        ...
        step4b: "",
        step4c: "",
        confirmmethod1: "취침 30분 전부터 인증 가능 시간입니다. 시작 버튼을 누르면 앱 잠금이 시작되고 인증이 완료됩니다.",
        confirmmethod2: "기상 30분 전부터 인증 가능 시간입니다. 약속한 시간이 지나면 인증 버튼이 비활성화됩니다.",
        examplePhoto1: "인증 예시",
    ...
    Mission(
        ...
        step3a: "STEP 3",
        step3b: "쉬는 시간을 설정하세요",
        step3c: "집중 모드 중 급한 용무가 생기거나, 쉬어야 하는 상황에 여러 번 앱 잠금을 해제할 수 있습니다. 단, 설정한 시간 모두 소진 시 쉬는 시간 사용이 불가합니다.",
        step4a: "STEP 4",
        step4b: "예치할 금액을 설정하세요",
        step4c: "정해진 시간에 시작하고 설정한 시간까지 포기하지 않으면 환급! 정해진 시간에 시작하지 못하거나 중간에 포기할 경우 벌금! 돈을 걸어 자제력을 높이고, 집중력을 높이세요!",
        confirmmethod1: "시작 시간 30분 전부터 인증 가능 시간입니다. 시작 시간이 되기 전까지 시작버튼을 눌러 앱 잠금을 시작해야 인증이 완료됩니다.",
