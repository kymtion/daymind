                    ...
                    ScrollView {
                        VStack(spacing: 35) {
                                ...
                                Image(mission.examplePhoto)
                                    ...
                                    .overlay(
                                        Rectangle() // 외곽선을 위한 직사각형
                                            .stroke(Color.blue.opacity(0.5), lineWidth: 2) // 파란색, 두께 2의 선
                                    )
                                    .opacity(0.8)
                                Text("인증 예시")
                            ...
                            VStack(spacing: 15) {
                                ...
                                .background(Color.green.opacity(0.1)) // 배경색 설정
                                .cornerRadius(10) // 외곽 둥글게 설정
                            ...
                            VStack(spacing: 15) {
                                ...
                                .background(Color.blue.opacity(0.1)) // 배경색 설정
                                .cornerRadius(10) // 외곽 둥글게 설정
